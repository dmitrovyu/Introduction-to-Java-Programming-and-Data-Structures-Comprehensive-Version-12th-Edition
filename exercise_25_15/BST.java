...
public class BST<E> implements Tree<E>{
     ...
     * Return true if the element is inserted successfully */
        ...
        //*****Implementing inorderList
        public java.util.List<E> inorderList(){
            java.util.ArrayList<E> list = new java.util.ArrayList<>();
            inorderList(root,list);
            return list;
        }
        /** InorderList traversal from a subtree 
         recursive helper method*/
        protected void inorderList(TreeNode<E> root, java.util.ArrayList<E> list){
            if(root == null) return;
       ...
       //**************** 
        ...
        /** postorder traversal from a sub-tree  recursive helper method*/
        protected void postorder(TreeNode<E> root){
         ...
         //*****Implementing postrderList
        public java.util.List<E> postorderList(){
            java.util.ArrayList<E> list = new java.util.ArrayList<>();
            postorderList(root, list);
            return list;
        }
        protected void postorderList(TreeNode<E> root, java.util.ArrayList<E> list){
            if (root == null) return;
        ...
        protected void preorder(TreeNode<E> root){
         ...
         //*****Implementing prerderList
        public java.util.List<E> preorderList(){
            java.util.ArrayList<E> list = new java.util.ArrayList<>();
            preorderList(root, list);
            return list;
        }
        protected void preorderList(TreeNode<E> root, java.util.ArrayList<E> list){
            if(root == null) return;
            list.add(root.element);
    ...
    * Return null if the element is not in the tree. */
    private TreeNode<E> getNode(E element){
        TreeNode<E> currentNode = root; //start from the root
        
        while(currentNode != null){
            if(c.compare(element, currentNode.element)<0){
                currentNode = currentNode.left;
            }
            else if(c.compare(element, currentNode.element)>0){
    ...
    public boolean isLeaf(E element){
        TreeNode<E> currentNode = getNode(element);
        if (currentNode == null) return false;
        else if((currentNode.left != null) || (currentNode.right != null)) return false;
        else return true;
    }
