...
public class Exercise_10_12 {
    public static void main(String[] args) {
        ...
        System.out.printf("The area of triangle is: %4.5f\n",t1.getArea());
        System.out.printf("The perimeter of triangle is: %4.5f\n",t1.getPerimeter());
        System.out.println("The point (3,3) is inside of triangle: " + t1.contains(new MyPoint(3,3)));
        System.out.println("The new triangle is inside of existing triangle: "
                            + t1.contains(new Triangle2D(new MyPoint(2.9, 2), new MyPoint(4, 1), new MyPoint(1.0, 3.4))));
        System.out.println("The new triangle overlaps existing triangle: " + t1.overlaps(new Triangle2D(new MyPoint(2,5.5),
